(function($) {
    ...
    $('.category-button').click(function() {
      ...
      if (selectedCategory === 'whatsapp') { // Don't send a message to chatbot if "Chat with human" was selected
        ...
        window.open("https://wa.me/31645800130?text=Estoy%20interesado%20en%20sus%20productos,%20¿puedo%20recibir%20más%20información?", '_blank');
        }
      else {
    ...
    let currentLanguage = 'es'; // Set a default language
